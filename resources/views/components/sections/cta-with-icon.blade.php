...
<section
    ...
    <div class="bg-elevation-02dp rounded-2xl sm:rounded-3xl p-4 sm:p-6 md:p-8 lg:p-10">
        <div
            class="flex flex-col sm:flex-row items-center justify-between gap-8 sm:gap-8 md:gap-12 lg:gap-16 xl:gap-20
            ...
            <div class="flex-1 text-center sm:text-left mb-6 lg:mb-0 px-2 sm:px-0 order-2 lg:order-2">
