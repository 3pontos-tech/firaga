...
<section
    ...
    <div class="bg-elevation-02dp rounded-2xl sm:rounded-3xl p-4 sm:p-6 md:p-8 lg:p-10">
        <div
            class="flex flex-col lg:flex-row items-center justify-between gap-6 sm:gap-8 md:gap-12 lg:gap-16 xl:gap-20 px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 py-8 sm:py-12 md:py-16 lg:py-20 xl:py-24">
            <div class="shrink-0 mb-6 lg:mb-0 order-1 lg:order-1">
                <span class="relative inline-block">
                    <x-filament::icon :$icon alt="Blog Icon"
                         class="w-12 h-12 sm:w-16 sm:h-16 md:w-18 md:h-18 lg:w-20 lg:h-20 text-brand-primary relative z-10"/>
                </span>
            </div>
