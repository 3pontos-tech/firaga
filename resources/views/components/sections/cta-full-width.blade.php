...
<section class="mt-16 sm:mt-24 md:mt-32">
    <div class="relative text-center py-16 flex flex-col items-center justify-center min-h-[300px] sm:min-h-[400px] md:min-h-[500px] lg:min-h-[600px] xl:min-h-[700px]">
        <img src="{{ $renderable?->getFirstMedia($header->component->value, $header->getCustomProperties())?->getUrl() ?? asset('images/stock/our-work.png') }}" alt="CTA Section" class="absolute inset-0 w-full h-full object-cover object-center brightness-30">
