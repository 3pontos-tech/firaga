...
<section class="py-12 md:py-16 border-b border-t border-outline-light dark:border-outline-dark mx-auto text-text-dark bg-elevation-01dp dark:text-text-light overflow-hidden ">
