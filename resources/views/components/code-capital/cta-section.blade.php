<section class="mt-16 sm:mt-24 md:mt-32 lg:mt-60">
    <div class="relative text-center flex flex-col items-center justify-center min-h-[300px] sm:min-h-[400px] md:min-h-[500px] lg:min-h-[600px] xl:min-h-[700px]">
        ...
        <div class="absolute top-2 left-2 sm:top-4 sm:left-4 md:top-6 md:left-6 lg:top-8 lg:left-8">
            <img src="{{ asset('images/border-corner.svg') }}" alt="CTA Section" class="w-[40px] h-[40px] sm:w-[60px] sm:h-[60px] md:w-[80px] md:h-[80px] lg:w-[100px] lg:h-[100px]">
        </div>
        ...
        <div class="relative z-10 flex flex-col items-center justify-center max-w-6xl mx-auto px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16">
            ...
            <x-layout.shared.button variant="custom" class="px-4 py-2 sm:px-6 sm:py-2 md:px-7 md:py-2.5 lg:px-8 lg:py-3 text-sm sm:text-base md:text-lg mt-4 sm:mt-6 md:mt-8 lg:mt-10 text-text-dark bg-gradient-to-r from-[#D6D6D6] via-[#FFFFFF] to-[#D6D6D6]">
                Agende sua análise
