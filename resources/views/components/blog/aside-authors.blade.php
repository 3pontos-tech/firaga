<div class="bg-surface rounded-xl p-6 hidden md:block"
    ...
    <div class="flex gap-3 mb-6">
        ...
        <h3 class="text-lg textneutral font-bold">Nossos Especialistas</h3>
    </div>
    <div class="space-y-4">
    ...
    <a href="{{ '// TODO: route here' }}"
       class="block mt-4 text-center textneutral text-sm  hover:textneutral-hover transition-colors">
