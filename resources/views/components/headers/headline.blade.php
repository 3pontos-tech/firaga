...
<div
    ...
    <h1 class="font-primary text-2xl sm:text-3xl md:text-4xl lg:text-4xl font-extrabold leading-tight mb-4 sm:mb-6 drop-shadow-lg tracking-tight text-heading text-center sm:text-left">
        {{ str($headline) }}
    </h1>
