...
@php
    ...
    $submenuData = [
        ...
        'nossos-servicos' => [
            'tabs' => [
                ['label' => 'Início', 'anchor' => '#hero'],
                ['label' => 'Flamma', 'anchor' => '#flamma'],
                ['label' => 'Planejamento Financeiro', 'anchor' => '#planejamento'],
                ['label' => 'Flare (IA)', 'anchor' => '#flare'],
                ['label' => 'Atendimento Premium', 'anchor' => '#premium'],
                ['label' => 'Educa Fire', 'anchor' => '#educafire'],
            ],
            'services' => [
                ['label' => 'Nossos Serviços', 'route' => 'nossos-servicos'],
                ['label' => 'Parcerias', 'route' => 'parcerias'],
        ...
        'trabalhe-conosco' => [
            'tabs' => [
                ['label' => 'Início', 'anchor' => '#hero'],
                ['label' => 'Comece sua carreira', 'anchor' => '#comece'],
                ['label' => 'Propósito', 'anchor' => '#proposito'],
                ['label' => 'Programa de Trainee', 'anchor' => '#cta-banner'],
            ],
            'services' => [
                ['label' => 'Nossos Serviços', 'route' => 'nossos-servicos'],
                ['label' => 'Parcerias', 'route' => 'parcerias'],
        ...
        'quem-somos' => [
            'tabs' => [
                ['label' => 'Início', 'anchor' => '#hero'],
                ['label' => 'Missão, Visão e Valores', 'anchor' => '#missao-visao-valores'],
                ['label' => 'Pilares', 'anchor' => '#pilares'],
                ['label' => 'Números', 'anchor' => '#numeros'],
                ['label' => 'Conteúdo que Transforma', 'anchor' => '#conteudo'],
            ],
            'services' => [
                ['label' => 'Nossos Serviços', 'route' => 'nossos-servicos'],
                ['label' => 'Parcerias', 'route' => 'parcerias'],
