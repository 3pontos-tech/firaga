<section class="bg-[#131314] border-y border-outline-dark min-h-screen py-16 flex items-center">
    <div class="container mx-auto flex flex-col gap-y-8 sm:gap-y-12 md:gap-y-16 justify-center items-center w-full">
