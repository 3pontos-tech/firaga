...
@php
    $mediaUrl = $renderable?->getFirstMediaUrl(\App\Enums\CustomComponent::HeroWithBackgroundImage->value);
...
<section class="relative overflow-hidden min-h-[60svh] sm:min-h-[65svh] md:min-h-[70svh] lg:min-h-[75svh] xl:min-h-[80svh]">
    ...
    <div class="absolute inset-0 z-0">
        ...
        <div class="absolute inset-0 bg-gradient-to-t from-elevation-surface/90 via-elevation-surface/60 to-elevation-surface/20 z-10 pointer-events-none"></div>
    </div>

    <!-- Content container -->
    <div class="relative z-20 container py-16 sm:py-20 md:py-24 lg:py-32">
        <x-headline :component="$headline" class="mx-auto max-w-2xl md:max-w-3xl lg:max-w-4xl text-center">
            <x-slot:actions>
