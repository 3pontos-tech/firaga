...
<section class="min-h-10/12 flex flex-col items-center justify-center mb-20">
    <div class="container px-4 sm:px-6 md:px-8">
        <div class="flex flex-col items-center justify-center gap-y-4 sm:gap-y-5 md:gap-y-6 text-center">
            <x-layout.shared.chip variant="primary" class="px-3 py-1.5 mt- sm:px-4 sm:py-2">
                {{ $badge }}
            </x-layout.shared.chip>
            <h1 class="font-bold text-text-high text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-5xl leading-tight max-w-4xl">
                {{ $heading }}
            </h1>
