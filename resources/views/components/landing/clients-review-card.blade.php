...
<div
    class="rounded-xl transition-all duration-500 ease-in-out space-y-8 text-white max-w-[424px] {{ $isActive ? 'bg-brand-primary h-fit relative px-8 pt-8 pb-3' : 'bg-outline-dark h-[340px] p-8' }}">
