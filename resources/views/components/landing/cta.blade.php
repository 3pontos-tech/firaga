<section
    ...
    <div class="container mx-auto px-6 relative z-10">
        <div
            class="bg-surface backdrop-blur-xl rounded-2xl p-10 lg:flex lg:items-center lg:justify-between lg:space-x-8 shadow-2xl sm:border sm:border-brand-hover animate-fade-in overflow-hidden">
            <!-- Left: Icon -->
            ...
            <div class="flex-shrink-0">
                <a
                    href="/blog"
                    class="relative inline-flex items-center bg-brand text-white font-semibold px-8 py-4 rounded-full shadow-lg hover:bg-brand-hover transition text-lg overflow-hidden group focus:outline-none focus:ring-2 focus:ring-orange-400"
                    aria-label="Ir para o blog"
                >

                    <span class="relative z-10 group-hover:scale-105 transition-transform">IR PARA O BLOG</span>
                    <svg class="w-6 h-6 ml-3 relative z-10 group-hover:translate-x-1 transition-transform" fill="none"
