    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
      ...
      <div class="space-y-6">
        ...
        <a href="/" class="inline-flex items-center space-x-2">
          <!-- Replace with your actual SVG or img tag -->
          <svg
          ...
          >
            <!-- Placeholder “F” icon -->
            <path d="M5 3l14 0v4l-8 0v10l-6 0v-14z" />
          </svg>
          <span class="text-2xl font-semibold text-white dark:text-white">Fire|Ce</span>
        </a>
      ...
      <div>
        <h4 class="text-xl font-semibold text-white mb-4">Links de Serviços</h4>
        <ul class="space-y-2">
          <li>
            <a href="/key-account" class="hover:text-white transition">
              Key Account
            </a>
          </li>
          <li>
            <a href="/code-capital" class="hover:text-white transition">
              Code Capital
            </a>
          </li>
          <li>
            <a href="/planejamento" class="hover:text-white transition">
              Planejamento
            </a>
          </li>
          <li>
            <a href="/educa-fire" class="hover:text-white transition">
              Educa Fire
            </a>
          </li>
          <li>
            <a href="/parcerias" class="hover:text-white transition">
              Parcerias
            </a>
          </li>
        </ul>
      ...
      <div>
        <h4 class="text-xl font-semibold text-white mb-4">Informações de Contato</h4>
        <p class="mb-4">
          Dr. Cardoso de Mello, 1666, Cj. 92<br />
          Vila Olímpia, São Paulo.
        </p>
        <p class="font-medium text-white">contato@firece.com.br</p>
            ...
            <span class="absolute inset-y-0 left-3 flex items-center text-gray-400">
              <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                      d="M16 12v6m-8-6v6m8-6l-4-4-4 4m8 6l-4-4-4 4M4 6h16" />
              </svg>
            </span>
            <input
              type="email"
              placeholder="Enter your email..."
              class="w-full pl-10 pr-4 py-2 rounded-lg bg-gray-700 placeholder-gray-500 text-white focus:outline-none focus:ring-2 focus:ring-orange-500"
            />
          </div>
          <button
            type="submit"
            class="w-full sm:w-auto bg-orange-500 hover:bg-orange-600 text-white font-medium px-6 py-2 rounded-lg transition"
          >
            INSCREVER-SE
          </button>
        </form>
