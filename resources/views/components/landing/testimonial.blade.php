...
<section id="depoimentos" class="relative bg-gradient-to-br from-black via-gray-900 to-black dark:from-black dark:via-gray-900 dark:to-black text-white dark:text-white py-24 md:py-28 overflow-hidden">
    ...
    <div class="container mx-auto px-6 relative z-10">
        ...
        <div class="flex flex-col md:flex-row justify-center items-center space-y-8 md:space-y-0 md:space-x-4 lg:space-x-6">

            <!-- Left Testimonial (smaller) -->
            <div class="w-full max-w-sm md:w-1/4 lg:w-1/5 scale-90 opacity-80 blur-[1px] md:blur-0 md:opacity-80 md:scale-90 transition-all duration-300 flex-shrink-0 md:mt-8">
                <blockquote class="relative bg-white/10 dark:bg-gray-900/30 backdrop-blur-xl rounded-2xl shadow-lg border border-orange-500/20 px-6 py-8 mb-6 overflow-hidden animate-fade-in">
                    ...
                    <span class="italic text-gray-200 text-base leading-relaxed">
                        A abordagem prática da plataforma me ajudou a sair das dívidas em menos de 6 meses!
                    </span>
                </blockquote>
                <div class="flex flex-col items-start space-y-1 px-2">
                    ...
                    <div class="flex items-center space-x-4">
                        <img src="https://randomuser.me/api/portraits/men/32.jpg" alt="Carlos Silva" class="w-10 h-10 rounded-full border-2 border-orange-400 object-cover hover:scale-110 transition-all duration-300" loading="lazy" />
                        <div>
                            <div class="text-white font-bold text-sm">Carlos Silva</div>
            ...
            <div class="w-full max-w-md md:w-1/3 scale-105 shadow-orange-500/30 hover:shadow-orange-500/40 hover:scale-[1.07] z-10 relative transition-all duration-300 flex-shrink-0 md:-mt-6">
                <blockquote class="relative bg-white/10 dark:bg-gray-900/30 backdrop-blur-xl rounded-2xl shadow-xl border border-orange-500/30 hover:border-orange-500/50 px-8 py-10 mb-8 overflow-hidden animate-fade-in transition-all duration-300">
                    ...
                    <span class="italic text-gray-200 text-xl leading-relaxed">
                        Sou apaixonado como a Fire|Ce tem me ajudado a mudar a minha vida financeira
                        de uma forma simples, educativa e com resultados
                        positivos expressivos desde o início.
                    </span>
                </blockquote>
                <div class="flex flex-col items-start space-y-1 px-2">
                    <!-- Estrelas -->
