    ...
    x-data="{
        ...
        toggle() {
            if (typeof $store !== 'undefined' && $store.theme) {
                ...
                localStorage.setItem('theme', this.isDark ? 'dark' : 'metallic');
                document.documentElement.classList.toggle('dark', this.isDark);
                document.documentElement.classList.toggle('metallic', !this.isDark);
                document.dispatchEvent(new CustomEvent('theme-changed', {
                    detail: { theme: this.isDark ? 'dark' : 'metallic' }
                }));
            }
        }
    }"
