<footer class="relative bg-surface text-primary-content py-16 overflow-hidden">
    <div class="container mx-auto px-6 relative z-10">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 animate-fade-in">
            <div class="space-y-6">
                ...
                <!-- Social Icons -->
                <div class="flex space-x-4 textneutral-hover">
                    <!-- LinkedIn -->
                    <a href="#"
                       class="w-10 h-10 bg-surface hover:textneutral rounded-full flex items-center justify-center transition group shadow-lg overflow-hidden">
            ...
            <div>
                ...
                <ul class="space-y-2">
                    <li>
                        <a href="/key-account" class="hover:textneutral-hover transition">
                            Key Account
                        </a>
                    </li>
                    <li>
                        <a href="/code-capital" class="hover:textneutral-hover transition">
                            Code Capital
                        </a>
                    </li>
                    <li>
                        <a href="/planejamento" class="hover:textneutral-hover transition">
                            Planejamento
                        </a>
                    </li>
                    <li>
                        <a href="/educa-fire" class="hover:textneutral-hover transition">
                            Educa Fire
                        </a>
                    </li>
                    <li>
                        <a href="/parcerias" class="hover:textneutral-hover transition">
                            Parcerias
                        </a>
                    </li>
                </ul>
            ...
            <div class="flex justify-evenly flex-col gap-2">
                ...
                <div>
                    <h4 class="text-xl font-semibold text-heading mb-2">Nosso Endereço</h4>
                    <p class="font-medium text-primary-content">contato@firece.com.br</p>
            ...
            <div>
                ...
                <p class="text-primary-content mb-6">
                ...
                <form class="flex flex-col sm:flex-row items-center sm:space-x-3 space-y-3 sm:space-y-0">
                    <input type="email" placeholder="Seu email" id="email"
                           class=" px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ringneutral transition-colors bg-surface ">
                    <button type="submit"
                            class="bg-neutral text-primary-content px-1 py-2 rounded-lg hover:bg-neutral-hover transition-colors">
                        Inscrever-se
                    </button>
                </form>
            </div>
