<x-layout.guest>
    ...
    <div class="bg-elevation-02dp dark:bg-[#232323]">
        ...
        <div class="flex flex-col gap-y-16 sm:gap-y-24 md:gap-y-32 lg:gap-y-40 xl:gap-y-60">
            <x-landing.our-work />
            <div class="h-[1px] bg-outline-medium container mx-auto"></div>
            <x-landing.solution-section />
            <x-landing.cta-section />
            <x-landing.our-solutions :solutions="$solutions" />
            <x-landing.plan-section :heading="$plansData['heading']" :description="$plansData['description']" :plans="collect($plansData['plans'])" />
