@php
    $herodata = [
        ...
        'subheading' =>
            'Estratégias internacionais de investimento personalizadas para engenheiros de software, designers e profissionais de tecnologia. Faça seu patrimônio crescer globalmente com orientação especializada.',
...
<x-layout.guest>
    ...
    <div class="bg-elevation-02dp dark:bg-[#232323] flex flex-col space-y-60 last:mb-60">
        ...
        <x-partials.faq :solutions="$solutions" :thumbnail="asset('images/stock/code-capital-person.png')" />
    </div>
